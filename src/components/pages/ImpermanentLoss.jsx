...
export default function ImpermanentLoss(){
	...
	return <div className="container impermanent">
		...
		{helpToggle && <div className="help-content mb-4 has-text-warning">
			...
			<p className="mb-3">
				After the initial conditions are set, adjust the token values relative to eachother and the fees generated by the pool to see if the end result leads to a loss or a gain. The relative value slider starts at 100%. Lowering it to 50% is equivalent to increasing it to 200% since impermant loss results from relative changes in value in either direction. 
			</p>
			<p className="mb-3">
				<a href="https://pintail.medium.com/uniswap-a-good-deal-for-liquidity-providers-104c0b6816f2" target="_blank" className="light-blue">Here</a> is a good article on it. It is worth following along with the example by entering the values into this calculator. 
			</p>
			<p className="mb-3">
		...
		<div className="is-size-5 mb-6">
			<div className="factory-list mb-2">
				...
				<span className="factory-list-amount has-text-info">{constantProduct()}</span>
			</div>

			<div className="factory-list">
				<span className="factory-list-name">One {token1Name ? token1Name : 'Token 1'} price</span>
				<span className="factory-list-amount has-text-info">{token2Amount / token1Amount} {token2Name ? token2Name : 'Token 2'}</span>
			</div>
			<div className="factory-list mb-2">
				<span className="factory-list-name">One {token2Name ? token2Name : 'Token 2'} price</span>
				<span className="factory-list-amount has-text-info">{token1Amount / token2Amount} {token1Name ? token1Name : 'Token 1'}</span>
			</div>

			<div className="factory-list">
				<span className="factory-list-name">Initial combined value in {token1Name ? token1Name : 'Token 1'}</span>
				<span className="factory-list-amount has-text-info">{token1Amount * 2}</span>
			</div>
			<div className="factory-list mb-2">
				<span className="factory-list-name">Initial combined value in {token2Name ? token2Name : 'Token 2'}</span>
				<span className="factory-list-amount has-text-info">{token2Amount * 2}</span>
			</div>
		</div>
		...
		<div className="is-size-5 mb-4">
			<div className="factory-list">
				<span className="factory-list-name">One {token1Name ? token1Name : 'Token 1'} price</span>
				<span className="factory-list-amount has-text-info">{newToken1Price()} {token2Name ? token2Name : 'Token 2'}</span>
			</div>
			<div className="factory-list mb-2">
				<span className="factory-list-name">One {token2Name ? token2Name : 'Token 2'} price</span>
				<span className="factory-list-amount has-text-info">{newToken2Price()} {token1Name ? token1Name : 'Token 1'}</span>
			</div>
		</div>
		...
		<div className="is-size-4 mb-3 light-green">
 		...
 		<div className="is-size-5 mb-4">
			<div className="factory-list">
				...
				<span className="factory-list-amount has-text-info">{newToken1Amount()}</span>
			</div>
			<div className="factory-list mb-2">
				<span className="factory-list-name">{token2Name ? token2Name : 'Token 2'} amount</span>
				<span className="factory-list-amount has-text-info">{newToken2Amount()}</span>
			</div>

			<div className="factory-list">
				<span className="factory-list-name">Final combined value in {token1Name ? token1Name : 'Token 1'}</span>
				<span className="factory-list-amount has-text-info">{finalCombinedToken1AmountIn()}</span>
			</div>
			<div className="factory-list mb-2">
				<span className="factory-list-name">Final combined value in {token2Name ? token2Name : 'Token 2'}</span>
				<span className="factory-list-amount has-text-info">{finalCombinedToken2AmountIn()}</span>
			</div>
		...
		<div className="is-size-5 mb-4">
			<div className="factory-list">
				<span className="factory-list-name">{token1Name ? token1Name : 'Token 1'} amount</span>
				<span className="factory-list-amount has-text-info">{token1Amount}</span>
			</div>
			<div className="factory-list mb-2">
				<span className="factory-list-name">{token2Name ? token2Name : 'Token 2'} amount</span>
				<span className="factory-list-amount has-text-info">{token2Amount}</span>
			</div>

			<div className="factory-list">
				<span className="factory-list-name">Final combined value in {token1Name ? token1Name : 'Token 1'}</span>
				<span className="factory-list-amount has-text-info">{finalCombinedToken1AmountOut()}</span>
			</div>
			<div className="factory-list mb-2">
				<span className="factory-list-name">Final combined value in {token2Name ? token2Name : 'Token 2'}</span>
				<span className="factory-list-amount has-text-info">{finalCombinedToken2AmountOut()}</span>
			</div>
		</div>
	</div>
